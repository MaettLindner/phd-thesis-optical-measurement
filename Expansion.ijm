...
open(input_path + fileList[f]);
	...
	// how many profile plots? -> set slice counter 
	total_slices = 10;
	...
	selectWindow("Log");
	saveAs(".txt", "C:\\Users\\lim38963\\Desktop\\MACRO\\Auswertung\\" + material + logstring + ".txt");
	print("\\Clear");
	//saveAs(".txt");
